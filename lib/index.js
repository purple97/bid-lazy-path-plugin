...
var BidLazyPathPlugin = /*#__PURE__*/function () {
  ...
  _createClass(BidLazyPathPlugin, [{
    ...
    value: function apply(compiler) {
      ...
      this.options.outputDir = this.options.outputDir.substring(1, this.options.outputDir.length); // compiler.hooks.beforeRun.tap(pluginName, (compilation) => {
      ...
      compiler.hooks.compilation.tap('RuntimePlugin', function (compilation) {// console.log(compilation.hooks);
      ...
      compiler.hooks.afterEmit.tap(pluginName, function (compilation) {// console.log(compilation.assetsInfo);
      });
