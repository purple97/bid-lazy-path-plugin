...
var BidLazyPathPlugin = /*#__PURE__*/function () {
  ...
  _createClass(BidLazyPathPlugin, [{
    ...
    value: function filterHostPaht(RawSource, mainDir) {
      ...
      var newCode = this.options.isLocal ? "{var _p=window.location.pathname.split('/');_p.length=_p.length-1;return _p.join('/')+\"/".concat(version, "/\"+e+\".js\"}") : "{return l.p+\"".concat(dir, "/").concat(version, "/\"+e+\".js\"}");
